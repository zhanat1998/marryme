  ...
  const packages = [
    ...
    },
    {
      ...
      includes: [
        { icon: "🤍", text: "Большое сердце (красное или белое)" },
        { icon: "🥳", text: "Надпись Happy Birthday" },
        { icon: "❤️", text: "Объёмные буквы МАМА / АПА / АПАКЕ / АПАКЕМ" },
    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 pt-20">
        <div className="absolute inset-0 z-0">
          <Image src="/mama-hero.png" alt="Сюрприз для мамы" fill
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto animate-fade-in-up">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6">
            Подарите маме
            <br />
            <span className="gradient-text">момент счастья</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            marryme_007 — организуем незабываемый сюрприз для вашей мамы.
            Буквы МАМА, живые цветы, лепестки роз, свечи, музыка — всё под ключ.
          </p>
      ...
      <section className="py-8 px-0">
        <div className="w-full">
          <div className="text-center mb-6 px-6">
            ...
            <p className="text-gray-400">Каждый сюрприз — с душой и любовью</p>
          </div>
          ...
          <div className="glass rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h2 className="text-4xl font-extrabold mb-4">
                Готовы сделать <span className="gradient-text">сюрприз для мамы?</span>
              </h2>
              <p className="text-gray-400 mb-8 text-lg leading-relaxed">
                Напишите нам — обсудим детали и создадим вечер, который она запомнит навсегда.
              </p>
              <a href={WHATSAPP} target="_blank" rel="noopener noreferrer"
